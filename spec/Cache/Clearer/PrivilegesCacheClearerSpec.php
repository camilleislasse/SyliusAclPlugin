...
namespace spec\BitBag\SyliusAclPlugin\Cache\Clearer;

use BitBag\SyliusAclPlugin\Cache\Clearer\PrivilegesCacheClearer;
use BitBag\SyliusAclPlugin\Privilege\PrivilegeInterface;
use PhpSpec\ObjectBehavior;
use Symfony\Component\Cache\Adapter\FilesystemAdapter;
use Symfony\Component\HttpKernel\CacheClearer\CacheClearerInterface;

final class PrivilegesCacheClearerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(PrivilegesCacheClearer::class);
    }
